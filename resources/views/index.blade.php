                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl py-2 border">
                            ...
                            @endif
                            <a href="{{ route('customer.profile.edit') }}" class="block px-4 py-2 text-sm hover:bg-gray-50">Profile Settings</a>
                    ...
                    @else
                    <button @click="$dispatch('open-login')" class="text-sm font-medium hover:text-gray-600 transition">Sign In</button>
                    @endauth
                </div>
            </div>
        </div>
