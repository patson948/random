                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        ...
                        <a 
                            ...
                            class="w-full inline-flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 transition font-medium text-gray-700"
                        >
